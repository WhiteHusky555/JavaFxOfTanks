 ...
 * В отличие от исходной C++-версии, где коды клавиш FLTK (65362, 65364 и т.п.)
 * были жёстко зашиты в {@code switch} внутри {@code GameController::handleKeyPress},
 * здесь управление можно поменять, отредактировав ресурс, без пересборки проекта.
 */
