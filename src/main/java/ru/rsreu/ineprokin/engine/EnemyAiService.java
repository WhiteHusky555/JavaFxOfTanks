 ...
 * <p>
 * В исходной C++-версии решения принимались каждый кадр с фиксированной
 * вероятностью (жёстко привязанной к предполагаемым 60 кадрам в секунду);
 * здесь у каждого танка — собственный таймер в секундах, независимый от FPS.
 */
