...
public final class GameConfig {
    ...
    /**
     * Какая доля попытки хода передаётся толкаемому танку (и самому толкающему)
     * за один тик, когда на пути оказывается другой танк. Меньше единицы —
     * чтобы протолкнуть чужой танк, требовалось на нём задержаться, а не
     * сдвигать его с места за один кадр, как пустую клетку.
     */
