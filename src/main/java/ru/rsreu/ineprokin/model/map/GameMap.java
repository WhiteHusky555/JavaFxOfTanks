 ...
 * <p>
 * В исходной C++-версии {@code GameMap} была изменяемым классом с методами
 * {@code setTile}/{@code resetToInitialState}, которыми на деле никто не
 * пользовался (стены никогда не разрушались) — вместо мёртвого API карта
 * здесь value-объект: она либо успешно построена и корректна, либо не
 * существует вовсе.
 * <p>
