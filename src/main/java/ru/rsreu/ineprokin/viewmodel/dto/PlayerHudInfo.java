 ...
 * @param extraLives сколько запасных жизней в кармане — подобранные бонусы "дополнительная жизнь"
 */
public record PlayerHudInfo(boolean available, boolean active, int score, int health, int maxHealth,
                             double reloadProgress, int extraLives) {

    public static PlayerHudInfo unavailable() {
        return new PlayerHudInfo(false, false, 0, 0, 0, 0.0, 0);
    }
}
